...
export default {
  ...
  iceServers: [
      ...
      },
      {
        ...
        username: "b4b08aacf1aeeeb285a431ed",
        credential: "XzdrX+fRxT40tO4h",
      },
      {
...
async startRecording() {
  ...
  this.mediaRecorder.onstop = () => {
    ...
    // Automatically trigger the download link
...
downloadRecording(url) {
  ...
  document.body.removeChild(a);
    ...
    // Start recording when the remote stream is received
    this.startRecording();
  };
